...
<div class="container">
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-table'></i> View Loan Schedule
        </h1>
    </div>
    <div class="row">
        <div class="col-xl-12">
                        ...
                        <div class="card-body">
                            <form>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="expected_payment_date" type="text" readonly class="form-control date" value="{{ date('d-m-Y', strtotime($data->expected_payment_date)) }}" placeholder="Expected Payment Date" name="expected_payment_date" required autocomplete="expected_payment_date">
                                    </div>
                                </div>
                            </form>
                        </div>
