...
<div class="container">
    <div class="subheader">
        ...
        {{-- <a href="{{ route('add.schdule',$id) }}" class="btn btn-primary waves-effect waves-themed text-white"><i
            class="fal fa-plus-circle"></i> Add Loan Schedule
        </a> --}}
                        ...
                        <div class="panel-tag">
                            ...
                            <form action="{{ route('import.schdule') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-3">
                                        <a class="btn btn-success mt-4" href="{{ route('export.schdule',$id) }}">
                                    ...
                                    {{-- {{ $item->expected_payment }} --}}
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="#exampleModal_{{ $item->id }}">
                                                    Edit
                                                </button>
...
<div class="container">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="{{ route('store.schdule',$id) }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="principal_payment" type="text" class="form-control"  placeholder="Principal Payment" name="principal_payment" value="{{ old('principal_payment') }}" required autocomplete="lender_name" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="interest_payment" type="text" class="form-control" placeholder="Interest Payment" name="interest_payment" value="{{ old('interest_payment') }}" required autocomplete="interest_payment">
    ...
    {{-- Add Loan Schedule End Here --}}

    {{-- Add Loan Payment Start Here --}}
                    ...
                    <div class="modal-body">
                        <form method="POST" action="{{ route('store.payment',$id) }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="interest_amount" type="text" class="form-control" placeholder="Payment Interest Amount" name="interest_amount" value="{{ old('interest_amount') }}" required autocomplete="interest_amount" autofocus>
        ...
        <div class="modal fade" id="exampleModal_{{ $row->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="{{ route('update.schdule',$row->id) }}" enctype="multipart/form-data">
                                @csrf
            ...
            <div class="modal fade" id="editPayment_{{ $row->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="POST" action="{{ route('update.payment',$row->id) }}" enctype="multipart/form-data">
                                    @csrf
