                                ...
                                <tbody>
                                    @foreach ($data as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $item->status }}</td>
                                            <td>
                                                <a href="{{ route('view_requested.loan',$item->id) }}" class="btn btn-sm btn-success">View</a>
                                                <a href="{{ route('approve.loan',$item->id) }}" class="btn btn-sm btn-primary">Approve</a>
                                                <a href="{{ route('reject.loan',$item->id) }}" class="btn btn-sm btn-danger">Reject</a>
                                            </td>
                                        </tr>
