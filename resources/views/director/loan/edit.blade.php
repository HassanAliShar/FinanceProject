                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('update.loan',$data->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="loan_type" type="text" class="form-control" value="{{ $data->loan_type }}" placeholder="Loan Type" name="loan_type" required autocomplete="identity_type">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="end_date" type="date" value="{{ $data->end_date }}" class="form-control" name="end_date" required autocomplete="end_date">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="loan_tenor" type="text" class="form-control" value="{{ $data->tenor }}" placeholder="Loan Tenor" name="tenor" required autocomplete="loan_tenor">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="provision_charges" type="text" class="form-control" value="{{ $data->provision_charges }}" placeholder="Perovision Charges" name="provision_charges" required autocomplete="provision_charges">
                                    </div>
                                </div>
