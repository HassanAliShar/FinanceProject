            ...
            <div id="panel-1" class="panel">
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        <div class="card-body">
                            <form method="POST" action="{{ route('update.payment',$data->id) }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="payment_date" type="text" class="form-control date" placeholder="DD/MM/YYYY" value="{{ date('d-m-Y', strtotime($data->payment_date)) }}" placeholder="Payment Date" name="payment_date" required autocomplete="payment_date">
                                    </div>
                                </div>
