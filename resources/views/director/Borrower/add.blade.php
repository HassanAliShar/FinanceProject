            ...
            <div id="panel-1" class="panel">
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        <div class="card-body">
                            <form method="POST" action="{{ route('store_borrower') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input id="internal_number" type="text" class="form-control" placeholder="Identity Number" name="internal_number" value="{{ old('internal_number') }}" required autocomplete="internal_number">

                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <label for="identity_no">Identity Number</label>
                                        <input id="identity_no" type="text" class="form-control" placeholder="Identity Number" name="identity_no" value="{{ old('identity_no') }}" required autocomplete="identity_no">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <label for="mother_maiden" >Mother Maiden Name Name</label>
                                        <input id="mother_maiden" type="text" class="form-control" placeholder="Mother Maiden Name Name" name="mother_maiden" required autocomplete="mother_maiden">
                                    </div>
                                    <div class="col-md-4 mb-3">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <label for="domicile_address" >Partner/Supouse Domicile Address</label>
                                        <input id="domicile_address" type="text" class="form-control" placeholder="Partner/Supouse Domicile Address" name="domicile_address" required autocomplete="domicile_address">
                                    </div>
                                    <div class="col-md-4 mb-3">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input id="business_capital" type="text" class="form-control" placeholder="Business Capitals" name="business_capital" required autocomplete="business_capital">
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12 mb-3" id="fields">
                                        <label for="bank_account" >Custom Fields</label>
