                            ...
                            <tbody>
                                @foreach ($data as $item)
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ route('manage.mg.schdule',$item->id) }}" class="btn btn-sm btn-primary">Payment/Schedules</a></td>
                                        <td>
                                            ...
                                            <a href="{{ route('delete.mg.loan',$item->id) }}" class="btn btn-sm btn-danger">Delete</a>
