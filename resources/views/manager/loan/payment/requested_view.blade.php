                        ...
                        <div class="card-body">
                            <form >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="payment_date" readonly type="text" class="form-control date" placeholder="DD/MM/YYYY" value="{{ date('d-m-Y', strtotime($data->payment_date)) }}" placeholder="Payment Date" name="payment_date" required autocomplete="payment_date">
                                    </div>
                                </div>
                                <div class="form-group row">
