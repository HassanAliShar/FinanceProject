            ...
            <div id="panel-1" class="panel">
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        <div class="card-body">
                            <form method="POST" action="{{ route('update.mg.schdule',$data->id) }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="principal_payment" type="text" class="form-control" value="{{ $data->principal_payment }}" placeholder="Principal Payment" name="principal_payment" value="{{ old('principal_payment') }}" required autocomplete="lender_name" autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="interest_payment" type="text" class="form-control" value="{{ $data->interest_payment }}" placeholder="Interest Payment" name="interest_payment" value="{{ old('interest_payment') }}" required autocomplete="interest_payment">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="expected_payment" type="text" class="form-control" value="{{ $data->expected_payment }}" placeholder="Expected Payment" name="expected_payment" required autocomplete="identity_type">
                                    </div>
                                </div>
