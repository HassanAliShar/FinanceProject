                            ...
                            <tbody>
                                @foreach ($data as $item)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('view.b.approve',$item->id) }}" class="btn btn-sm btn-primary">View</a>
                                            <a href="{{ route('edit.b.approve',$item->id) }}" class="btn btn-sm btn-info">Edit</a>
                                            <a href="{{ route('delete.b.approve',$item->id) }}" class="btn btn-sm btn-danger">Delete</a>
                                        </td>
                                    </tr>
